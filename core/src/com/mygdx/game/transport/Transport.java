...
public abstract class Transport implements Serializable {
    ...
    public boolean sost_fire_bot,guidance,left_mouse,right_mouse,trigger_attack;
    ...
    public void tower_iteration_bot(int iTr){
        for (i = 0;i<tower_obj.size();i++){
            tower_obj.get(i).tower_action(iTr,this.x,this.y,this.rotation_corpus,this.trigger_attack,aim_x,aim_y);
        }
    }
    ...
    public boolean fire_bot(double obj_x,double obj_y){
        ...
        g +=90;
        if (g_right < g && g_left > g && guidance) {
            this.reload = this.reload_max;
            return true;
        }
        return false;
    ...
    public void physic_collision(ArrayList<Transport>obj_2, int i){
        ...
        double[]xy = metod.tower_xy(x,y,0,0,corpus_height_2/1.5,-rotation_corpus);
        double x_1_1 = xy[0];
        double y_1_1 = xy[1];
        xy = metod.tower_xy(x,y,0,0,-corpus_height_2/1.5,-rotation_corpus);
        double x_1_2 = xy[0];
        double y_1_2 = xy[1];
        xy = metod.tower_xy(x_2,y_2,0,0,obj_2.get(i).corpus_height_2/1.5,-obj_2.get(i).rotation_corpus);
        double x_2_1 = xy[0];
        double y_2_1 = xy[1];
        xy = metod.tower_xy(x_2,y_2,0,0,-obj_2.get(i).corpus_height_2/1.5,-obj_2.get(i).rotation_corpus);
        double x_2_2 = xy[0];
        double y_2_2 = xy[1];
        double g_1_1i2_1 = atan2(y_1_1 -y_2_1,x_1_1 - x_2_1)/ 3.1415926535 * 180;
        //double g_2_1i1_1 = atan2(y_2_1 -y_1_1,x_2_1 - x_1_1)/ 3.1415926535 * 180;
        double g_1_1i2_2 = atan2(y_1_1 -y_2_2,x_1_1 - x_2_2)/ 3.1415926535 * 180;
        double g_1_2i2_1 = atan2(y_1_2 -y_2_1,x_1_2 - x_2_1)/ 3.1415926535 * 180;
        double g_1_2i2_2 = atan2(y_1_2 -y_2_2,x_1_2 - x_2_2)/ 3.1415926535 * 180;
        double g_2_2i1_2 = atan2(y_2_2 -y_1_2,x_2_2 - x_1_2)/ 3.1415926535 * 180;
        double rotation_corpus_1 = atan2(y -y_1_2,x - x_1_2)/ 3.1415926535 * 180;
        double rotation_corpus_2 = atan2(y_2 -y_2_2,x_2 - x_2_2)/ 3.1415926535 * 180;
        System.out.println(teg_unit);
        System.out.println(rotation_corpus_1);
        System.out.println(rotation_corpus);
        System.out.println(g_2_2i1_2);
        System.out.println(obj_2.get(i).teg_unit);
        System.out.println(rotation_corpus_2);
        System.out.println(obj_2.get(i).rotation_corpus);
        System.out.println(g_2_2i1_2);
//        System.out.println(Math.abs(g_1_2i2_2-rotation_corpus_1));
//        System.out.println(Math.abs(g_1_2i2_2-rotation_corpus_2));
        //System.out.println(g_1_2i2_2-rotation_corpus_1);
        //System.out.println(g_2_2i1_2-rotation_corpus_2);
        if(sqrt(pow(x_1_2 - x_2_2, 2) + pow(y_1_2 - y_2_2, 2))<(obj_2.get(i).corpus_width_2+corpus_width_2)*1.2){
            if(Math.abs(g_2_2i1_2-rotation_corpus_2)<200){
                if(g_2_2i1_2>0){
                    rotation_corpus += (abs(obj_2.get(i).speed)+1)*z;
                }
                else if(g_2_2i1_2<0){
                    rotation_corpus -= (abs(obj_2.get(i).speed)+1)*z;
                }
            }
            else if(Math.abs(g_2_2i1_2-rotation_corpus_1)<200){
                if(g_2_2i1_2>0){
                    obj_2.get(i).rotation_corpus += (abs(speed)+1)*z;
                }
                else if(g_2_2i1_2<0){
                   obj_2.get(i).rotation_corpus -= (abs(speed)+1)*z;
                }
        ...
        else if(sqrt(pow(x_1_1 - x_2_1, 2) + pow(y_1_1 - y_2_1, 2))<(obj_2.get(i).corpus_width_2+corpus_width_2)*1.2){
            if(Math.abs(g_1_1i2_1-rotation_corpus_2)<120){
                if(g_1_1i2_1<0){
                    rotation_corpus += (abs(obj_2.get(i).speed)+1)*z;
                }
                else if(g_1_1i2_1>0){
            ...
            else if(Math.abs(g_1_1i2_1-rotation_corpus_1)<120){
                if(g_1_1i2_1<0){
                    obj_2.get(i).rotation_corpus += (abs(speed)+1)*z;
                }
               else if(g_1_1i2_1>0){
    ...
    public void inertia_xy() {
        ...
        if (this.speed_inert > 0.1) {
            ...
            if (this.speed_inert < 0.2 && this.speed_inert > -0.2) {
                this.speed_inert = 0;
            }
        }
    }
    ...
    public void tower_action(int i,double x,double y,double rotation,boolean sost_fire_bot,double x_fire,double y_fire){
        this.update();
